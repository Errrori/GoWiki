...
需要完整代码实现的，请移步 [GoWiki实现]([Errrori/GoWiki](https://github.com/Errrori/GoWiki))；其中main分支对应全文的代码实现，optimized_version分支实现了文末的四个任务的代码，每个commit对应一个任务，可以参考实现（第一个任务不需要实际代码，所以没有记录）
---
